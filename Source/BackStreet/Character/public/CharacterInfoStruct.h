...
public:
	...
	//PlayerMaxHP는 1.0f
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (UIMin = 0.5f, UIMax = 10.0f))
		float CharacterMaxHP = 1.0f;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (UIMin = 0.1f, UIMax = 10.0f))
		float CharacterAtkMultiplier = 1.0f;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (UIMin = 0.2f, UIMax = 1.0f))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (UIMin = -1.0f, UIMax = 1.0f))
