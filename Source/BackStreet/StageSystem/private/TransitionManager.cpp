...
void UTransitionManager::TeleportCharacter()
{
	...
	{
		if (currentStage->CharacterSpawnPoint[0] != nullptr)
		{
			moveLocation = currentStage->CharacterSpawnPoint[0]->GetActorLocation();
	...
	characterRef->SetActorLocation(moveLocation);
